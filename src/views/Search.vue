            ...
            > 
              ...
              >       
                ...
                > 
                  <v-img
                    ...
                    height="200px"
                  >
                    <v-card-title class="caption font-weight-light"><v-icon x-small left>mdi-map-marker-outline</v-icon>{{anuncio.vendedor.endereco.bairro}}, {{anuncio.vendedor.endereco.cidade}}</v-card-title>
                  </v-img>
                  <!--
                  <v-img
                    :src="image"
                  ...
                  >
                    <v-row class="white--text">
                      <v-col>
                        <div><v-icon x-small left>mdi-map-marker</v-icon>{{anuncio.vendedor.endereco.bairro}}, {{anuncio.vendedor.endereco.cidade}}</div>
                      </v-col>
                    </v-row>
                  </v-img>
                  -->
              ...
              <v-list-item>
                ...
                <v-list-item-content>
                  ...
                  -->
                  <v-list-item-subtitle class="caption">
                    <v-avatar size="24" left v-if="anuncio.vendedor.url">
                      <img
                    ...
                    <v-icon v-else x-small left>mdi-account-circle</v-icon> {{anuncio.vendedor.nome}} 
