          ...
          >
            <v-card elevation="0">
              ...
              <v-card-text>
                    ...
                    <template v-for="(tag, i) in ads.adicionais">
                      ...
                      >
                        <template v-slot:default="{ active, toggle }">
                          ...
                          <v-list-item-content>
                            <v-list-item-title>ADICIONAR {{tag.nome}}</v-list-item-title>
                          </v-list-item-content>
                ...
                <div><span class="subheading">Quantidade ({{ quantidadeestoque=ads.quantidade }}):</span></div>
                <v-row justify="start">
...
<script>
  ...
  export default {
    ...
    metaInfo(){
      return{
        title: `${this.titulo} - Aluga Já!`,
        meta: [
          {name: 'description', content: 'Descrição: ' + this.descricao + ' - Aluga Já'},
          {property: 'og:title', content: this.titulo + ' - Aluga Já'},
          {property: 'og:site_name', content: 'Aluga Já'},
          {property: 'og:description', content: 'Descrição: ' + this.descricao + ' - Aluga Já'},
          {property: 'og:type', content: 'product'},
          {property: 'og:url', content: 'https://alugaja.app/product2/' + this.product},
          {property: 'og:image', content: this.imagem}    
        ]
      }
    },
    firebase:{
        ...
        if(d.length==11){
          const sms = axios({
            ...
            data: {
              ...
              'mensagem': 'Aluga Já! R$'+this.vTotal+' Você recebeu uma proposta em '+this.titulo+'. Acesse: https://sherrer-b43e8.web.app/sale e confirme a sua entrega!!!'  
            }
          });
